 ...
 *
 * @param <T> entity based on database table
 * @param <K> type of id variable in entity
 * @author PWOJTKOW
 */
public interface IDao<T, K extends Serializable> {
     ...
     *
     * @param id - entity id to get from database
     ...
     *
     * @param id - entity id to find from database
     ...
     *
     * @param id - specific id number for entity to be deleted.
     */
    void delete(K id);
     ...
     *
     * @param id - specific record id in table.
